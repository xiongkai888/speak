...
import com.lanmei.speak.tts.control.InitConfig;
import com.lanmei.speak.tts.listener.UiMessageListener;
import com.lanmei.speak.tts.util.AutoCheck;
...
public class TTSHelper {
     ...
     */
    protected String appId = "11623451";

    protected String appKey = "EDkNv5ELTYSn6Q54OfNI6bQd";

    protected String secretKey = "W2VVFQiPw1xSmOoWoSAOuri2LL3fCo99";
...
//                print("离线资源存在并且可读, 目录：" + TEMP_DIR);
     ...
     *
     * @param msg
     * @param isContinuous 是否连续播报
     */
    public void speak(String msg,boolean isContinuous) {
        /* 以下参数每次合成时都可以修改
         *  mSpeechSynthesizer.setParam(SpeechSynthesizer.PARAM_SPEAKER, "0");
         *  设置在线发声音人： 0 普通女声（默认） 1 普通男声 2 特别男声 3 情感男声<度逍遥> 4 情感儿童声<度丫丫>
