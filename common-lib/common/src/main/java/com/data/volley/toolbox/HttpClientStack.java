...
import com.data.volley.toolbox.multipart.FilePart;
import com.data.volley.toolbox.multipart.MultipartProgressEntity;
import com.data.volley.toolbox.multipart.StringPart;
...
//		if (request instanceof MultiPartRequest) {
		if (request instanceof MultiPartRequest && ((MultiPartRequest)request).hasFileToUpload()) {
			...
			final Map<String, List<String>> filesToUpload = ((MultiPartRequest<?>) request).getFilesToUpload();
