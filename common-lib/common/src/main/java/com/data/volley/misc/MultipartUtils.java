...
import com.data.volley.toolbox.multipart.MultipartEntity;
...
public class MultipartUtils {
    ...
    public static int getContentLengthForMultipartRequest(String boundary, Map<String, MultiPartRequest.MultiPartParam> multipartParams, Map<String, List<String>> filesToUpload) {
