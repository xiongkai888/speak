...
/**
 * Created by tianyi on 2015/1/19.
 */
/*
 ...
 * {@link FrameLayout} in a vertical orientation, presenting a vertical array
...
public class OverScrollView extends FrameLayout implements OnTouchListener
{
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev)
    {
		 ...
		 * drag mode.
		 */
//        return mIsBeingDragged;//滑动时子控件无法点击，修改
        return false;
    }
    ...
    private boolean overScrollView()
    {
        ...
        if (currScrollY < contentTop)
        {
            ...
            if((contentTop-currScrollY)>200){
                if(scrollViewListener!=null){
                    scrollViewListener.onPullUpToRefresh();
                }
            }
        } else if (currScrollY + displayHeight > contentBottom)
        {
            ...
            if(scrollViewListener!=null){
                scrollViewListener.onPullDownToRefresh();
            }
        }
