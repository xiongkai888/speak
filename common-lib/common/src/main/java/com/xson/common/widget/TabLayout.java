...
public class TabLayout extends HorizontalScrollView {
    ...
    private ArrayList<OnTabSelectedListener> mOnTabSelectedListeners;
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(Build.VERSION.SDK_INT >= 11) {
            a = context.getTheme().obtainStyledAttributes(attrs, new int[]{
    ...
    void selectTab(TabLayout.Tab tab, boolean updateIndicator) {
        if(this.mSelectedTab == tab) {
            if(this.mSelectedTab != null) {
                if(this.mOnTabSelectedListeners != null) {
                    for(OnTabSelectedListener listener : mOnTabSelectedListeners)
                        listener.onTabReselected(this.mSelectedTab);
                }
            ...
            if(this.mSelectedTab != null && this.mOnTabSelectedListeners != null) {
                for(OnTabSelectedListener listener : mOnTabSelectedListeners)
                    listener.onTabUnselected(this.mSelectedTab);
            }
            ...
            if (custom != null) {
                ...
                if (hasText) {
                    if (mTextView == null) {
                        ...
                        textView.setLineSpacing(0, mSpacingMult);
