...
import com.squareup.picasso.bitmap_recycle.ByteArrayPool;
 ...
 * ({@link #canHandleRequest(Request)} and {@link #load(Request, int, ByteArrayPool)}) with your custom logic to
 * load images.
 * <p>
...
public abstract class RequestHandler {
  /**
   * {@link Result} represents the result of a {@link #load(Request, int, ByteArrayPool)} call in a
   * {@link RequestHandler}.
   *
   * @see RequestHandler
   * @see #load(Request, int, ByteArrayPool)
   */
  public static final class Result {
     ...
     * {@link #load(Request, int, ByteArrayPool)} call.
     */
    ...
    /**
     * Returns the resulting EXIF orientation generated from a {@link #load(Request, int, ByteArrayPool)} call.
   ...
   */
  @Nullable public abstract Result load(Request request, int networkPolicy, ByteArrayPool byteArrayPool) throws IOException;
