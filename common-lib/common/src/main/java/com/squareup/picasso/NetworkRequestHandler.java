...
import com.squareup.picasso.bitmap_recycle.ImageHeaderParser;
...
class NetworkRequestHandler extends RequestHandler {
  ...
  @Override public Result load(Request request, int networkPolicy, ByteArrayPool byteArrayPool) throws IOException {
...
//    return new Result(is, loadedFrom);
    ...
    markStream.mark(1024);
    int orientation = new ImageHeaderParser(markStream, byteArrayPool).getOrientation();
    markStream.reset();
